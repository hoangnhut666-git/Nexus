...
public sealed class CategoryImageService(IWebHostEnvironment environment) : ICategoryImageService
{
  public const string UploadRelativePath = "uploads/categories";
